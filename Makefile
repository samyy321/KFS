...
SRC_NAME = main.cpp VgaBuffer.cpp GlobalDescriptorTable.cpp MemLib.cpp InterruptsManager.cpp KbdHandler.cpp DisplayablesManager.cpp Shell.cpp String.cpp
